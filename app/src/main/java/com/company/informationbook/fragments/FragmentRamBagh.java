...
public class FragmentRamBagh extends Fragment {
    public static FragmentRamBagh newInstance(){
        return new FragmentRamBagh();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view=inflater.inflate(R.layout.fragment_ram_bagh,container,false);

        imageViewTajMahal=view.findViewById(R.id.imageViewTajMahal);
        progressBarTajMahal=view.findViewById(R.id.progressBarTajMahal);

        imageViewTajMahal.setImageResource(R.drawable.rambagh);
